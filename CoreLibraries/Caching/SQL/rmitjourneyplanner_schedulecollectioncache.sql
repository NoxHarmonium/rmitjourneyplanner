...
--
-- Table structure for table `schedulecollectioncache`
--

DROP TABLE IF EXISTS `schedulecollectioncache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `schedulecollectioncache` (
  ...
  `lowFloor` int(10) unsigned DEFAULT NULL,
  `requestDate` datetime DEFAULT NULL,
  `data` text,
  PRIMARY KEY (`cacheID`),
  KEY `main` (`stopID`,`routeID`,`lowFloor`,`requestDate`)
) ENGINE=InnoDB AUTO_INCREMENT=20022 DEFAULT CHARSET=utf8 PACK_KEYS=1;
