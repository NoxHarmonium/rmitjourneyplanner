...
--
-- Table structure for table `nodecache`
--

DROP TABLE IF EXISTS `nodecache`;
...
CREATE TABLE `nodecache` (
  ...
  `stopObject` text,
  PRIMARY KEY (`cacheID`),
  KEY `stopID` (`stopID`,`networkID`)
) ENGINE=InnoDB AUTO_INCREMENT=2416 DEFAULT CHARSET=utf8 PACK_KEYS=1;
