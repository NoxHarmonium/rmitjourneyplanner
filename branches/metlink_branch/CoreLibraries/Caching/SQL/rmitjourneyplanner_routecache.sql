...
--
-- Table structure for table `routecache`
--
...
CREATE TABLE `routecache` (
  ...
  `stopIndex` int(10) unsigned DEFAULT NULL,
  `stopDirection` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`cacheID`),
  KEY `routeID` (`routeID`,`stopDirection`)
) ENGINE=InnoDB AUTO_INCREMENT=7430 DEFAULT CHARSET=utf8 PACK_KEYS=1;
...
-- Dump completed on 2011-12-12 16:54:41
